...
//how to run: node create-wallet.js wallet 0xa7b5e3f3eb7acef733a8ga48hej7aca6c2d4d750c2f3d6f737648d57227da139 0.001
...
const provider = new JsonRpcProvider('https://sepolia.infura.io/v3/cfed69d3b4fd4630b1957335cdb517cb');
let signer = wallet.connect(provider);
let transaction = await signer.sendTransaction({
    to: newWallet.address,
    value: ethers.parseEther(seedTokenAmount)
})
