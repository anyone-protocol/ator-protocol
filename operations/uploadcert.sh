...
consul kv put ator-network/stage/dir-auth-$2/authority_certificate $(cat keys/authority_certificate)
consul kv put ator-network/stage/dir-auth-$2/ed25519_master_id_public_key_base64 $(base64 keys/ed25519_master_id_public_key)
consul kv put ator-network/stage/dir-auth-$2/ed25519_signing_cert_base64 $(base64 keys/ed25519_signing_cert)
consul kv put ator-network/stage/dir-auth-$2/fingerprint $(cat fingerprint)
consul kv put ator-network/stage/dir-auth-$2/fingerprint-ed25519 $(cat fingerprint-ed25519)
