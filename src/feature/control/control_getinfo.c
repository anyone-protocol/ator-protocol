...
static const getinfo_item_t getinfo_items[] = {
  ITEM("version", misc, "The current version of Anon."),
  ...
  ITEM("dormant", misc,
       "Is Anon dormant (not building circuits because it's idle)?"),
  ...
  DOC("status/bootstrap-phase",
      "The last bootstrap phase status event that Anon sent."),
  DOC("status/clients-seen",
      "Breakdown of client countries seen by a bridge."),
  DOC("status/fresh-relay-descs",
      "A fresh relay/ei descriptor pair for Anon's current state. Not stored."),
  DOC("status/version/recommended", "List of currently recommended versions."),
  DOC("status/version/current", "Status of the current version."),
  ITEM("address", misc, "IP address of this Anon host, if we can guess it."),
  ITEM("address/v4", misc,
       "IPv4 address of this Anon host, if we can guess it."),
  ITEM("address/v6", misc,
       "IPv6 address of this Anon host, if we can guess it."),
  ...
  ITEM("uptime", misc, "Uptime of the Anon daemon in seconds."),
